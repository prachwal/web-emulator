...
export function createCpc464Demo(cols: number, rows: number): AttributeTextScreen {
  ...
  w(0, 1, cols >= 80 ? '64K Z80A  16MHz  27 COLOURS  CASSETTE' : '64K Z80A  27 COL', 3, 0);
  ...
  if (rows > 18) w(1, 18, '0123456789 .,;:!?()[]{}', 3, 0);
  return s;
}
...
export function createCpc664Demo(cols: number, rows: number): AttributeTextScreen {
  ...
  w(0, 1, '64K Z80A  3" FLOPPY  CP/M 2.2', 3, 0);
  ...
  if (rows > 11) {
    ...
    w(1, 13, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 3, 0);
...
export function createCpc6128Demo(cols: number, rows: number): AttributeTextScreen {
  ...
  w(0, 1, '128K Z80A  CP/M 3.1  3" FLOPPY', 3, 0);
  ...
  if (rows > 11) {
    ...
    w(1, 12, 'CP/M 3.1  AMSDOS  RS-232', 3, 0);
  }
  if (rows > 14) {
    w(1, 14, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 2, 0);
    w(1, 15, '0123456789 .,;:!?()[]{}', 3, 0);
  }
  return s;
}
